...
internal enum StoryboardScene {
  ...
  internal enum Main: StoryboardType {
    ...
    internal static let notFoundViewController = SceneType<NotFoundViewController>(storyboard: Main.self, identifier: "NotFoundViewController")

    internal static let progressViewController = SceneType<ProgressViewController>(storyboard: Main.self, identifier: "ProgressViewController")
  }
